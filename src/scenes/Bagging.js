class Bagging extends Phaser.Scene {
    ...
    create() {
        ...
        this.bag = this.add.sprite(game.config.width/2 + borderPadding * 5, 115 + 50, "checkout_bag").setOrigin(0,0).setScale(4.5,3.75);
        ...
        for (let i = 0; i < cart.length; i++) {
            cart[i] = cart[i].remake(this, -(200*(i)) - 100, grd1.y - 200 - 10 + 50);
    ...
    update(time, delta) {
        //these 4 lines make the game consistant across computers
        ...
        if (this.frameTime > 16.5) {  
            ...
            for (let i = 0; i < cart.length; i++) {
                ...
                if (cart[i].exist == false) {
                    ...
                    if ((cart[i].y > (game.config.height - borderPadding * 10)) && (cart[i].y < game.config.height - borderPadding * 14.5 + 50)) { //ground's y
                    ...
                    if((cart[i].y < 270) && (cart[i].y > 0) && (cart[i].x < game.config.width/2 + borderPadding * 30) && (cart[i].x > game.config.width/2 + borderPadding * 6) &&
