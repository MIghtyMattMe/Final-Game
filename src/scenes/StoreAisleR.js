...
class StoreAisleR extends Phaser.Scene {
    ...
    create() {
        ...
        this.leftButton = this.add.sprite(-40, 280, "button_left").setOrigin(0,0).setScale(.70).setInteractive().on("pointerdown", ()=> {
            this.scene.start("storeAisleChipsScene");
        });
        this.leftButton2 = this.add.sprite(250, 240, "button_left").setOrigin(0,0).setScale(.60).setInteractive().on("pointerdown", ()=> {
            this.scene.start("storeAisleCerealScene");
        });
        this.rightButton = this.add.sprite(game.config.width - 270, 280, "button_right").setOrigin(0,0).setScale(.65).setInteractive().on("pointerdown", ()=> {
